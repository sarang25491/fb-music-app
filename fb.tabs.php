...
<div style="margin-top: 10px; border-top: 1px solid #d8dfea; padding: 3px 16px; height: 14px; color: #3b5998;">
	<div style="float: left;"><fb:visible-to-owner><a href="<?php echo $config['fb']['fburl']; ?><?php if($_POST['fb_sig_is_admin']) echo '?fb_page_id=' . $_POST['fb_sig_profile_id'] . ''; ?>">edit player</a></fb:visible-to-owner></div>
